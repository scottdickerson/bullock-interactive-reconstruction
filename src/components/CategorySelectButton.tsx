...
const CategorySelectButton = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-4 backdrop-blur-[2px] z-10 bg-black/50 rounded-lg border-4 border-yellow-400 "></div>

      {/* Content Overlay */}
      <div className="relative z-20 flex items-center justify-center h-full p-18 ">
        <h3 className="text-2xl font-bold text-button group-hover:text-yellow-300 transition-colors text-center">
          {name.split('/').join('/ ')}
        </h3>
      </div>
    </a>
