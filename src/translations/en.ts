    ...
    agriculture: {
      ...
      options: {
        newOpportunities: {
          ...
          image:
            'Family and ox cart in front of house, ca. 1888. Courtesy The Cook Collection, The Valentine',
        },
        challengesAndDangers: {
          ...
          image:
            'Downtown Austin, 1920. Courtesy Austin History Center, Austin Public Library',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
    ...
    communityLeadership: {
      ...
      options: {
        ...
        challengesAndDangers: {
          ...
          image:
            'Businesses in 500 block of East Commerce Street, San Antonio, Texas, 1917. Courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            'This photograph looks out on Soledad Street near Main Plaza, the area where Duval ran his barbershop. Soledad Street, San Antonio, Texas, ca. 1870. Courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
      },
    },
    politics: {
      ...
      options: {
        newOpportunities: {
          ...
          image:
            'Portrait of Richard Allen. Courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
    ...
    education: {
      ...
      options: {
        newOpportunities: {
          ...
          image:
            'African American School in Diboll, Texas, with teacher J. W. Hogg and students. Courtesy The History Center',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
        ...
        viewArtifact: {
          title: 'View Artifact',
          image:
            'This report shows that Smith initially focused on teaching her 28 students (19 girls and 9 boys) to spell, read, and write. Report of School for Freedmen, June 1, 1866. Courtesy National Museum of African American History and Culture',
        },
      },
    },
    entrepreneurship: {
      ...
      options: {
        newOpportunities: {
          ...
          image:
            'Elm Street, Dallas, Texas. Courtesy DeGolyer Library, Southern Methodist University',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
