export const en = {
  ...
  pullscreen: {
    ...
    subtitle: 'Emancipation brought opportunity but it did not equal equality.',
    description:
      "On June 19, 1865, Union General Gordon Granger arrived in Galveston to announce that over 250,000 enslaved people in Texas were free. After the Civil War ended, the state entered a period of Reconstruction. This era radically reshaped government and redefined formerly enslaved people's rights as citizens. Black Texans forged new paths forward while confronting racist policymaking.",
  },
  select: {
    ...
    details:
      'Many Black Texans continued working in agriculture, purchasing or leasing land. Others pursued a formal education or ran for public office. Faced with hostility and violence from white Texans, Black Texans created spaces for community connection and free expression.',
    detailsLine2:
  ...
  content: {
    agriculture: {
      ...
      description:
        "Before Emancipation, Ransom Williams (ca. 1846–1901) was enslaved by the Bunton family in Mountain City, Texas. By 1871, he had purchased 45 acres of land near Bear Creek in Travis County. Four years later, he married Sarah Houston. Together, they ran a successful farm that produced food to sustain their family and cotton to sell for profit. The Williams earned enough to start a horse raising business, buy fine goods, and invest in their children's education.",
      options: {
        newOpportunities: {
          ...
          content:
            "Some white landowners exploited the labor of Black Texans to limit their financial freedom. Apprenticeship and tenant farming laws allowed landowners to create contracts that tied workers to the land. By owning his property, Ransom kept all the profits of his work. Financial success allowed Ransom and Sarah to better their family's quality of life and education.",
          image:
            'Family and ox cart in front of house, ca. 1888. Image courtesy The Cook Collection, The Valentine',
        },
        challengesAndDangers: {
          ...
          image:
            'Downtown Austin, 1920. Image courtesy Austin History Center, Austin Public Library',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            'Williams registered his horse brand, "RA," in Travis County in April 1872. This fragment found on the Williams Farmstead matches the brand he filed with the county. Brand from Ransom\'s farm. Image courtesy Texas Archaeological Research Laboratory, The University of Texas at Austin',
        },
      },
    },
    communityLeadership: {
      name: 'Nace Duval',
      description:
        'Nace Duval was a preacher, community leader, and businessman in San Antonio. In 1866, Duval organized the first Black Methodist congregations in Bexar County. The St. James and St. Paul churches were gathering places that met community needs. Within these spaces, Duval established a school and employment agency. Available to church members, the services helped advance education and job prospects. Duval also owned a barbershop on Soledad Street that served clients of any race.',
      options: {
        newOpportunities: {
          title: 'New Opportunities',
          description:
          ...
          image:
            'Mount Zion Baptist Church, San Antonio, Texas. Image courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
          ...
          image:
            'Businesses in 500 block of East Commerce Street, San Antonio, Texas, 1917. Image courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            'This photograph looks out on Soledad Street near Main Plaza, the area where Duval ran his barbershop. Soledad Street, San Antonio, Texas, ca. 1870. Image courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
      },
    },
    politics: {
      name: 'Richard Allen',
      description:
        "Richard Allen (ca. 1830–1909) was born enslaved in Richmond, Virginia, and came to Texas with his enslaver J.J. Cain in 1837. Allen was a skilled carpenter who built Mayor Joseph R. Morris's mansion and the Buffalo Bayou bridge in Houston. After Emancipation, Allen became a federal voting registrar and agent with the Freedmen's Bureau. He represented the 14th District in the Twelfth Legislature and became the first Black man to run for Lieutenant Governor in 1878.",
      options: {
        newOpportunities: {
          title: 'New Opportunities',
          description:
          ...
          image:
            'Portrait of Richard Allen. Image courtesy General Photograph Collection, UTSA Special Collections, San Antonio',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
          ...
          image:
            'Nicodemus Historic District, Graham County, KS. Image courtesy Library of Congress, Washington D.C.',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            'Allen signed this oath while serving in the Twelfth Legislature. Legislators were required to swear that they did not engage in insurrection while holding office. Oath of Office, April 26, 1870. Image courtesy Texas State Library and Archives Commission, Austin',
        },
      },
    },
    education: {
      name: 'Harriet Smith',
      description:
        "Harriet Smith learned to read and write while still enslaved in Wharton, Texas. In 1866, Colonel Dennis hired her to teach 28 children of the tenant farmers on his plantation. Eventually, Smith asked the Freedmen's Bureau to oversee the school. This transfer separated the 28 students' education from their former enslaver's control.  Agency reports show that Smith was an excellent teacher skilled in geography, arithmetic, and ethics. She became the principal of a Freedmen's Bureau school for almost 100 students in Bryan by 1869.",
      options: {
        newOpportunities: {
          title: 'New Opportunities',
          description:
        ...
        challengesAndDangers: {
          ...
          image:
            'Group of Black Students, 1870s. Image courtesy University of North Texas Libraries, The Portal to Texas History, crediting Austin History Center, Austin Public Library',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            'This report shows that Smith initially focused on teaching her 28 students (19 girls and 9 boys) to spell, read, and write. Report of School for Freedmen, June 1, 1866. Image courtesy National Museum of African American History and Culture',
        },
      },
    },
    entrepreneurship: {
      ...
      options: {
        newOpportunities: {
          ...
          image:
            'Elm Street, Dallas, Texas. Image courtesy DeGolyer Library, Southern Methodist University',
        },
        challengesAndDangers: {
          title: 'Challenges and Dangers',
          description:
          ...
          image:
            'African American woman doing laundry. Image courtesy Library of Congress, Washington D.C.',
        },
        viewArtifact: {
          title: 'View Artifact',
          image:
            "This entry recognizes Isaac and Hope Thompson's joint purchase of land from W. L. and Lou Williams. The property remained in Hope's possession as she continued to build her investments after Isaac left. Dallas County Deed Index, vol. 53 p. 210, April 29, 1871. Image courtesy Dallas County Records Department",
        },
      },
    },
  },
